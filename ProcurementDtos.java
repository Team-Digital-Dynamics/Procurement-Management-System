...
public final class ProcurementDtos {
    ...
    public record SupplierRequest(@NotBlank String name, @Email @NotBlank String contactEmail,
                                  String phone, String taxNumber) {
    }

    public record SupplierResponse(Long id, String name, String contactEmail, SupplierStatus status,
    ...
    public record RequisitionResponse(Long id, String title, RequisitionStatus status, BigDecimal totalAmount,
    ...
    public record EvaluationRecordResponse(Long id, Long rfqId, Long quotationId, Long supplierId,
                                           BigDecimal priceScore, BigDecimal deliveryScore,
                                           BigDecimal qualityScore, BigDecimal termsScore,
                                           BigDecimal performanceScore, BigDecimal totalWeightedScore,
                                           String evaluatedBy, java.time.Instant evaluatedAt, String notes) {
    }
}
